...
def guess_include_dirs():
    ...
    #local = '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages/numpy/core/include/numpy/'
    local = '/System/Library/Frameworks/Python.framework/Versions/2.7/Extras/lib/python/numpy/core/include/numpy/'
    return [pypath, numpypath, local, '/opt/local//include/']
